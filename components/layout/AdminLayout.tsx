        ...
        <SidebarFooter className="p-4 border-t border-border">
          <div className="flex flex-col gap-3">
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton
                  className="w-full justify-start gap-3 h-auto p-2 hover:bg-muted rounded-md border-2 border-transparent hover:border-border transition-colors group-data-[collapsible=icon]:justify-center"
                >
        ...
        <header className="sticky top-0 z-40 flex min-h-16 shrink-0 items-center justify-between gap-2 border-b border-border bg-background/95 px-4 backdrop-blur-md sm:px-6">
          <div className="flex items-center gap-4 min-w-0 flex-1">
            ...
            <div className="flex flex-col leading-tight min-w-0">
              <h1 className="text-lg sm:text-xl font-black tracking-tight uppercase truncate">{title}</h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            >
              <Icon name="home" size={18} className="transition-transform group-hover:scale-110" />
            ...
            {mounted && (
              ...
              >
                <Icon name={theme === "dark" ? "light_mode" : "dark_mode"} size={20} className={theme === "dark" ? "text-secondary-brand" : "text-primary"} />
              </button>
            )}
