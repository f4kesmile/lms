...
>(
  (
    ...
    // We use useControlledState so that the sidebar state can be manipulated from outside the component.
...
>(
  (
    ...
    const collapsedState = state === "collapsed" ? collapsible : "";
    ...
    return (
      <div
        ...
        data-state={state}
        data-collapsible={collapsedState}
      ...
      >
        ...
        <div
          ...
          data-side={side}
          className={cn(
            "relative h-dvh w-[var(--sidebar-width)] bg-transparent transition-[width] duration-200 ease-in-out",
        ...
        <div
          ...
          data-variant={variant}
          className={cn(
            "fixed inset-y-0 z-20 hidden h-dvh w-[var(--sidebar-width)] flex-col bg-sidebar transition-[left,right,width] duration-200 ease-in-out md:flex",
            side === "left"
            ...
            variant === "floating" || variant === "inset"
              ...
              : "data-[collapsible=icon]:w-[var(--sidebar-width-icon)] data-[side=left]:border-r data-[side=right]:border-l",
            className,
          )}
          {...props}
        >
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      "m-0 flex w-full min-w-0 list-none flex-col gap-2.5 p-0",
      className,
    )}
    {...props}
  />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center justify-start gap-4 overflow-hidden rounded-md p-3 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!h-[52px] group-data-[collapsible=icon]:!w-full group-data-[collapsible=icon]:!justify-start group-data-[collapsible=icon]:!px-3.5 [&>svg]:size-6 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-11 text-xs",
        lg: "h-16 text-sm group-data-[collapsible=icon]:!px-3.5",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  const width = React.useMemo(() => {
    return `${Math.floor(0.7 * 40) + 50}%`; // Stable value for lint
  }, []);
  ...
  return (
    <div
      ...
      {...props}
    >
      {showIcon && <div className="size-4 rounded-md bg-sidebar-accent/10" />}
      <div
        className="h-4 flex-1 max-w-[var(--skeleton-width)] rounded-md bg-sidebar-accent/10"
        style={
          {
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 m-0 flex min-w-0 list-none translate-x-px flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5",
      "group-data-[collapsible=icon]:hidden",
      className,
    )}
    {...props}
