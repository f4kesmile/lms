          ...
          >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <Badge
                          ...
                          className={cn(
                            ...
                            subject.status === "published" ? "bg-primary" : "",
                          )}
                        >
              ...
              : activeTab === "kelas"
                    ...
                    return (
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="secondary"
                            className="font-black text-[10px] uppercase tracking-wider px-3 py-1 rounded-xl"
                          >
                ...
                : (() => {
                    ...
                    return (
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="flex size-12 items-center justify-center rounded-2xl bg-secondary-brand/10 text-secondary-brand shadow-inner">
                            <Calendar className="size-6" />
                          </div>
                          {year.isCurrent && (
                            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary shadow-sm">
                        ...
                        {!year.isCurrent && (
                          <Button
                            variant="outline"
                            className="w-full font-black text-[10px] uppercase tracking-widest h-10 border-primary/30 text-primary hover:bg-primary hover:text-on-primary rounded-xl shadow-sm transition-all duration-300"
            ...
            <div className="mt-6 flex items-center justify-end gap-2 border-t border-border/30 pt-4">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="h-9 w-9 text-destructive hover:bg-destructive hover:text-destructive-foreground rounded-xl transition-transform hover:scale-110"
