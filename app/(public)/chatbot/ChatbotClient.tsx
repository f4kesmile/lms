    ...
    <>
      ...
      <main className="app-shell" style={{ display: "grid", gap: "2rem" }}>
        ...
        <div className="grid-2" style={{ alignItems: "start" }}>
          ...
          <aside style={{ display: "grid", gap: "1rem", alignContent: "start" }}>
            <article className="stat-card">
              ...
              <p className="stat-value" style={{ color: "var(--text-main)" }}>{turns.length}</p>
            </article>
            <article className="stat-card" style={{ background: "var(--bg-card)", borderColor: "var(--border-primary)" }}>
              <div className="row" style={{ gap: "0.5rem", marginBottom: "0.5rem" }}>
                <span className="material-symbols-outlined" style={{ fontSize: 20, color: "var(--primary)" }}>
                  star
                </span>
              ...
              <p className="stat-value" style={{ color: "var(--text-main)" }}>{avgRating}</p>
            </article>
            <article className="stat-card" style={{ background: "var(--bg-card)", borderColor: "var(--border-primary)" }}>
              <div className="row" style={{ gap: "0.5rem", marginBottom: "0.5rem" }}>
                <span className="material-symbols-outlined" style={{ fontSize: 20, color: "var(--primary)" }}>
        ...
        <section className="neo-card" style={{ padding: "1.5rem", display: "grid", gap: "1rem" }}>
          ...
          <div className="chat-stream" style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            {turns.map((turn, idx) => (
              <article key={turn.id} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                {/* User Bubble */}
                <div style={{
                  alignSelf: "flex-end",
                ...
                <div style={{
                  ...
                  <p className="text-dim" style={{ fontSize: "0.8rem", marginTop: "0.5rem", display: "inline-flex", alignItems: "center", gap: "0.25rem" }}>
                    <span className="material-symbols-outlined" style={{ fontSize: 14 }}>timer</span>
                    {turn.responseTimeMs ?? "-"} ms
                  </p>
                  
                  <div style={{ marginTop: "1rem", paddingTop: "1rem", borderTop: "1px dashed var(--border-primary)" }}>
