                  ...
                  return (
                    <div className="space-y-5">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex size-12 shrink-0 items-center justify-center rounded-md border border-border bg-primary/10 text-primary shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-xs font-bold text-muted-foreground line-clamp-2 leading-relaxed opacity-90">
                          {subject.description ||
                ...
                ? (() => {
                    ...
                    return (
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 bg-muted/50 p-3 rounded-md border border-border">
                          <div className="size-10 rounded-md border border-border bg-background flex items-center justify-center text-[12px] font-black text-foreground shadow-sm">
