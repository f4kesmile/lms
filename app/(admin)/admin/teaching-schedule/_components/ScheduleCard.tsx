      ...
      <div className="relative space-y-6">
        <div className="space-y-3">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-1 min-w-0">
               <Badge variant="outline" className="font-extrabold text-[9px] tracking-widest px-2 py-0 border-primary/20 bg-primary/5 text-primary">
                {item.subject.code}
              </Badge>
          ...
          <div className="flex flex-wrap gap-2">
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-secondary-brand/10 border border-secondary-brand/20 text-secondary-brand">
              ...
              <span className="text-[10px] font-black uppercase tracking-wider">{item.class.name}</span>
            </div>
            {item.schedule.room && (
              <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-muted/50 border border-border/50 text-muted-foreground">
                ...
                <span className="text-[10px] font-black uppercase tracking-wider">{item.schedule.room}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="p-5 rounded-3xl bg-muted/20 border border-border/30 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground leading-none mb-1">Waktu Kuliah</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground leading-none mb-1">Dosen Pengampu</p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <Link 
            href={`/admin/courses/${item.subject.id}/students` as Route}
