        ...
        <div className="relative hidden flex-col justify-between bg-primary p-10 lg:col-span-5 lg:flex">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 text-lg font-medium leading-relaxed text-primary-foreground/80">
              Akses materi berkualitas, kolaborasi real-time, dan asisten akademik AI terintegrasi untuk masa depan yang lebih cerah.
            </p>
          </div>
          ...
          <div className="relative z-10 flex flex-col gap-6">
            <div className="flex items-center gap-5 text-primary-foreground">
              ...
              <div>
                ...
                <p className="text-sm font-medium opacity-70">Kurikulum dioptimalkan untuk industri</p>
              </div>
            </div>
            <div className="flex items-center gap-5 text-primary-foreground">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary-foreground/10 backdrop-blur-xl">
              ...
              <div>
                ...
                <p className="text-sm font-medium opacity-70">Bantuan belajar 24/7 di ujung jari</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center p-6 lg:col-span-7">
          <div className="w-full max-w-sm">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-black tracking-tight text-foreground lg:text-4xl">Masuk Akun</h2>
              <p className="mt-1 text-sm font-medium text-muted-foreground">Silakan masuk untuk melanjutkan belajar.</p>
            </div>
            ...
            <form className="mt-6 flex flex-col gap-4" onSubmit={submit}>
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-xs font-black text-primary hover:underline">Lupa Sandi?</Link>
                </div>
                <div className="relative flex items-center">
              ...
              <div className="flex items-center gap-4 py-1">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.25em] text-muted-foreground">Atau Masuk Dengan</span>
                <div className="h-px flex-1 bg-border" />
              </div>
            ...
            <p className="mt-8 text-center text-sm font-medium text-muted-foreground">
              Belum punya akun?{" "}
              <Link href="/register" className="font-black text-[var(--primary)] hover:opacity-80 hover:underline transition-all decoration-[var(--primary)]/30 underline-offset-4">Daftar sekarang</Link>
            </p>
          </div>
        </div>
      </div>
